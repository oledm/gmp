...
'device': {'carrier': 'Природный газ',
            ...
            'full_desc_capital': 'Адсорбер зав.№ 2162, рег.№ 23051/а, инв.№ '
                                 '100712',
            'id': 1,
            'inv_number': '100712',
 ...
 'files': {'control_UK_connections': [{'id': 1697,
                                       'name': 'Снимок '
                                               'экрана_2016-05-25_14-02-11.png',
                                       'url': 'http://127.0.0.1:8000/media/16/60/16607d402ea4970d2c08a4ecaf9a585d'}],
           'control_UK_container': [{'id': 1696,
                                     'name': 'Вакансия Ведущий фронт-энд '
                                             'разработчик (Front-end, HTML, '
                                             'CSS, JS) в Москве.png',
                                     'url': 'http://127.0.0.1:8000/media/4f/9b/4f9b8edaa19930c482f40294b75973d5'}],
           'control_VIK': [{'id': 1695,
                            'name': '5.png',
                            'url': 'http://127.0.0.1:8000/media/ff/72/ff72d1ef1dc1c8b910612b5abdd9bf19'}],
           'control_magnit': [{'id': 1698,
                               'name': 'Тест JS.png',
                               'url': 'http://127.0.0.1:8000/media/4a/7b/4a7b94f60ea1ab9d980ca0cd8fdf4224'}],
           'hydra': [{'id': 1699,
                      'name': 'Вакансия Ведущий фронт-энд разработчик '
                              '(Front-end, HTML, CSS, JS) в Москве.png',
                      'url': 'http://127.0.0.1:8000/media/4f/9b/4f9b8edaa19930c482f40294b75973d5'}],
           'legend': [{'id': 1694,
                       'name': '4.png',
                       'url': 'http://127.0.0.1:8000/media/66/84/6684c55bea5c184d360d697a7080b593'}],
           'licenses': [{'id': 1700,
                         'name': 'IMG_20160425_085321_HDR.jpg',
                         'url': 'http://127.0.0.1:8000/media/16/d5/16d59643f7309fd08e974ebca4c1264e'}],
           'warrant': [{'id': 1701,
                        'name': 'Платеж на Тройку (не прошел!).png',
                        'url': 'http://127.0.0.1:8000/media/6c/3a/6c3a01a7f824e989a06fa3e3a27cbf55'}]},
 'info': {'danger_places': 'Места концентраций напряжений – продольные и '
          ...
          'info_repair': 'В представленной технической документации не '
                         'отмечено',
          'investigation_date': '2016-06-26T00:00:00.000Z',
          'license': 'Договор субподряда между ООО «ГАЗМАШПРОЕКТ» и ООО '
                     '«Стройгазмонтаж»',
          'license_category': 'fdfds',
          'license_date': '2016-06-11T00:00:00.000Z',
          'license_more': '',
          'license_number': 'fdsf'},
 'lpus': [{'id': 6, 'name': 'Алмазное ЛПУ МГ'},
          {'id': 7, 'name': 'Бардымское ЛПУ МГ'},
          {'id': 8, 'name': 'Березниковское ЛПУ МГ'},
          {'id': 9, 'name': 'Воткинское ЛПУ МГ'},
          {'id': 10, 'name': 'Горнозаводское ЛПУ МГ'}],
             ...
             'UT': {
                    ...
                    'results': [{'value': 'Минимальная измеренная толщина '
                                ...
                                {'value': 'Минимальная измеренная толщина '
                                          ...
                                          'скорость коррозии составляет  '
                                          'мм/год'}],
                    'measures': [{'data': [{'passport': '11', 'real': '555'},
                                           {'passport': '4343', 'real': '43'},
                                           {'passport': '6664', 'real': '34'},
                                           {'passport': '6546456',
                                            'real': 'памвапыавы'},
                                           {'passport': 'павп',
                                            'real': 'пвапва'}],
                                 ...
                                 {'data': [{'passport': 'ваы',
                                           ...
                                           {'passport': 'рапрп',
                                            'real': '45345'},
                                           {'passport': 'вррп', 'real': 'рпа'},
                                           {'passport': 'пвапа', 'real': 'рп'}],
                                  'title': 'ДНИЩЕ ВАЩЕ!'}]},
 ...
 'signers': {'create': {'fio': 'fds', 'rank': 'fds'}},
